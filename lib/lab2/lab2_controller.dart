...
class Lab2Controller extends GetxController {
  ...
  Future updateData({useCache = true}) async {
    ...
    var data = PlotData.fromResults(results: results, tag: 'L1', voltage: true, color: Colors.red, token: 'L1/V1');
    var data2 = PlotData.fromResults(results: results, tag: 'V1', voltage: true, color: Colors.red);
    data.min = 999999999;
    data.max = -999999999;
  ...
  Future loadInfo() async {
    info.trigger(await rootBundle.loadString('assets/lab2.md'));
  }
